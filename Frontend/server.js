...
io.on('connection', (socket) => {
  ...
  socket.on('commerceCreation', async (data) => {
    ...
    try {
      ...
      const response = await axios.post('http://51.83.69.138:8012/api/commerce/creation', formData, {
        headers: {
  ...
  socket.on('evenementCreation', async (data) => {
    ...
    try {
      ...
      const response = await axios.post('http://51.83.69.138:8012/api/commerce/evenement', formData, {
        headers: {
          "Content-Type": "multipart/form-data",
      },
      });
  ...
  // }
    ...
    try {
      ...
      const response = await axios.post('http://51.83.69.138:8012/api/produit/creation', formData, {
        headers: {
          "Content-Type": "multipart/form-data",
      },
      });
  ...
  // }
    ...
    try {
      ...
      const response = await axios.post('http://51.83.69.138:8012/api/service/creation', formData, {
        headers: {
          "Content-Type": "multipart/form-data",
      },
      });
  ...
  // }
    ...
    try {
      ...
      const response = await axios.post('http://51.83.69.138:8012/api/promotion/creation', formData, {
        headers: {
          "Content-Type": "multipart/form-data",
      },
      });

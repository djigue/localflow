...
const Connexion = ({ setIsAuthenticated }) => {
    ...
    socket.on("connexionResponse", (data) => {
      ...
      if (data.success) {
        ...
        if (data.user_role === "commercant") {
          // Redirection vers la page d'accueil commerçant
          navigate("/accueil");
        } else {
  ...
  }, [setIsAuthenticated, navigate]);  // Ajoutez navigate dans les dépendances
  ...
  return (
    ...
    <div className="container d-flex justify-content-center align-items-center min-vh-100">
      ...
      <div className="card shadow-lg p-4" style={{ maxWidth: "400px", width: "100%" }}>
        ...
        {message && (
          <div className={`alert ${message.includes("Erreur") ? "alert-danger" : "alert-success"} text-center`} role="alert">
            {message}
          </div>
        )}
